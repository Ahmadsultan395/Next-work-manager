...
const Login = () => {
  ...
  return (
    <div className='my-5 flex justify-center items-center w-full px-10'>
      ...
      <div className='bg-[url("/login/formBg2.jpg")] w-auto sm:w-[600px]  md:w-[700px] rounded-lg p-5 place-items-center border-2 border-gray-200 shadow-lg shadow-gray-300'> 
